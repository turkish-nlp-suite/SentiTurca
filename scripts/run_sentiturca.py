#!/usr/bin/env python
# coding=utf-8
"""Finetuning the library models for sequence classification on SentiTurca."""
...
class DataTrainingArguments:
    ...
    def __post_init__(self):
        if self.task_name is not None:
            ...
            raise ValueError("Need either a SentiTurca task, a training/validation file or a dataset name.")
        else:
...
def main():
    ...
    if data_args.task_name is not None:
        ...
        if training_args.do_predict:
            if data_args.test_file is not None:
                ...
                raise ValueError("Need either a SentiTurca task or a test file for `do_predict`.")
    ...
    if data_args.task_name is not None:
        ...
        kwargs["dataset"] = f"SentiTurca {data_args.task_name.upper()}"
